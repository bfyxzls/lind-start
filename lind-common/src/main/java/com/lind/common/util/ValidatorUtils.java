...
public class ValidatorUtils {
  ...
  private static boolean validRegionCode(String regionCode) {
    String[] regionCodes = {"11", "12", "13", "14", "15", "21",
                            "22", "23", "31", "32", "33", "34", "35", "36", "37",
                            "41", "42", "43", "44", "45", "46", "50", "51", "52",
                            "53", "54", "61", "62", "63", "64", "65", "71", "81",
                            "82", "91"};
    if (Arrays.binarySearch(regionCodes, regionCode) < 0) {
      return false;
    }
    return true;
  }
  ...
  private static boolean validVarifyCode(String idCard) {
    ...
    if (!strVerifyCode.equals(idCard.substring(idCard.length() - 1, idCard.length()))) {
      return false;
    }
    return true;
  }
