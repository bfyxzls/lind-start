...
public class SwaggerAutoConfiguration {
    ...
    private SecurityScheme securitySchema(SwaggerProperties swaggerProperties) {

        return new ApiKey("Authorization", "Authorization", "header");
        //ArrayList<AuthorizationScope> authorizationScopeList = new ArrayList<>();
        //swaggerProperties.getAuthorization().getAuthorizationScopeList()
        //        .forEach(authorizationScope ->
        //                authorizationScopeList.add(new AuthorizationScope(authorizationScope.getScope(),
        //                        authorizationScope.getDescription())));
        //ArrayList<GrantType> grantTypes = new ArrayList<>();
        //swaggerProperties.getAuthorization().getTokenUrlList().forEach(tokenUrl -> grantTypes.add(new
        // ResourceOwnerPasswordCredentialsGrant(tokenUrl)));
