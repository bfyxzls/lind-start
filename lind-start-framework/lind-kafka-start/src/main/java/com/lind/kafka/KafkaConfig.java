...
public class KafkaConfig {
    ...
    @Value("${spring.kafka.consumer.group-id:group1}")
    ...
    /**
     * earliest新消费者从头开始头消息,latest只读最新的.
     */
    ...
    /**
     * 只有当代理允许使用 auto.create.topics.enable 的情况下才生效，尽量关闭这个，因为比较危险
     */
    @Value("${spring.kafka.consumer.allow.auto.create.topics:true}")
