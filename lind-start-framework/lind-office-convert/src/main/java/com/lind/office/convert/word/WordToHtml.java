...
public class WordToHtml {
     ...
     * @throws Exception
     */
    public String docToHtml(String sourceFileName, String imagePathStr, String imagePathResolver, String targetFileName) throws Exception {
     ...
     * @throws Exception
     */
    public String docxToHtml(String sourceFileName, String imagePathStr, String imagePathResolver, String targetFileName) throws Exception {
