...
public class QuartzServiceImpl implements QuartzService {
    ...
    public void addJob(JobDto jobDto, Map<String, Object> argMap) {
        ...
        scheduler.start();
        //构建job信息
        JobDetail jobDetail = JobBuilder.newJob(((Class<? extends Job>) Class.forName(jobDto.getJobClassName()))).withIdentity(jobName, groupName).withDescription(jobDto.getDesc()).build();
