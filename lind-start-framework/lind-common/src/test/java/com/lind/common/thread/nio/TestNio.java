...
public class TestNio {
    ...
    public void nioAsyncParse(final int numberOfFiles, final int numberOfThreads, final int bufferSize) throws IOException, ParseException, InterruptedException {
        ...
        for (int f = 0; f < numberOfFiles; f++) {
            consumerThreads.acquire();
             AsynchronousFileChannel channel = AsynchronousFileChannel.open(Paths.get(TEST_FILE), EnumSet.of(StandardOpenOption.READ), pool);
