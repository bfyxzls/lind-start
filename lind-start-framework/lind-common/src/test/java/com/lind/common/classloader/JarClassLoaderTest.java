...
public class JarClassLoaderTest {
     ...
     */
    @Test
    public void loadDynamicMethod() throws ClassNotFoundException, IllegalAccessException, NoSuchFieldException, IOException, InstantiationException, NoSuchMethodException, InvocationTargetException {
     ...
     */
    @Test
    public void loadInterfaceMethod() throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        JarClassLoader.joinJar(CommonApplication.class, "file:///D:\\github\\classloadhot\\target\\classloadhot-1.0-SNAPSHOT.jar");
      //  Class clazz1 = JarClassLoader.getSystemClassLoader().loadClass("com.tool.Demo");
