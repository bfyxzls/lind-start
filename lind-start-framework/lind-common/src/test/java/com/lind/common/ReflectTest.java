...
//        vehical.run();
        ...
        IVehical vehical = (IVehical) Proxy.newProxyInstance(Thread.currentThread()
                .getContextClassLoader(), Car.class.getInterfaces(), new InvocationHandler() {
            @Override
            public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                System.out.println("---------before-------");
        ...
        bootstrap.group(nioEventLoopGroup)
                ...
                .handler(new ChannelInitializer<SocketChannel>() {
                    ...
                    public void initChannel(SocketChannel channel) throws Exception {
                        channel.pipeline()
                                .addLast(new IdleStateHandler(0,0,1, TimeUnit.SECONDS))    // beat N, close if fail
                         ;
                    }
                })
