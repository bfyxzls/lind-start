...
public class EsIndexUtils implements ConstUtils {
    ...
    public static boolean createIndex(RestHighLevelClient client, IndexDTO indexDTO) throws IOException {
        ...
        request.settings(Settings.builder()
                .put(SHARDS_SETTING, getValueOrDefault(indexDTO.getNumberOfShards(), 3))
     ...
     * @return
     */
    public static boolean putMapping(RestHighLevelClient client, String indexName, Collection<FieldDTO> fieldDTOS) throws IOException {
    ...
    public static boolean createIndexAndPutMapping(RestHighLevelClient client, IndexDTO indexDTO,
        ...
        if (indexCreated) {
            try {
                return EsIndexUtils.putMapping(client, indexName,
                        fieldDTOS);
            } catch (Exception e) {
     ...
     * @return
     */
    public static boolean putColumnMapping(RestHighLevelClient client, String indexName,
                                           Collection<FieldDTO> fieldDTOS) throws IOException {
     ...
     * @throws IOException
     */
    public static boolean putSettings(RestHighLevelClient client, String indexName, Map<String, String> settings) throws IOException {
    ...
    public static LinkedHashMap<String, LinkedHashMap<String, Object>> getFieldMapping(RestHighLevelClient client,
        ...
        GetMappingsResponse response = client.indices().getMapping(getMappingsRequest,
                RequestOptions.DEFAULT);
