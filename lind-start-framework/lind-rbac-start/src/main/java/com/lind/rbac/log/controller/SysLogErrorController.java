...
import com.lind.rbac.log.dto.SysLogErrorDTO;
import com.lind.rbac.log.excel.SysLogErrorExcel;
...
public class SysLogErrorController {
    ...
    public CommonResult<PageData<SysLogErrorDTO>> page(@ApiIgnore @RequestParam Map<String, Object> params){
