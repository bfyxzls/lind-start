...
public class TokenController {
    ...
    public void authorizationCodeLogin(@RequestParam(required = false) String code,
    ...
    public ResponseEntity login(String unionId, HttpServletRequest request) throws IOException {
        ...
        String kcUrl = keycloakSpringBootProperties.getAuthServerUrl()
                + "/realms/"
                + keycloakSpringBootProperties.getRealm()
                + "/protocol/openid-connect/auth?scope=openid&response_type=code&client_id=" + keycloakSpringBootProperties.getResource()
                + "&unionId=" + unionId
