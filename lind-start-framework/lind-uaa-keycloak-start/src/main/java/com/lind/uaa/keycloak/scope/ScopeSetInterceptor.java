...
/**
 * scopeSet注解拦截器，主要拦截具有@ScopeSet的方法.
 * 过滤器：可以获得Http原始的请求和响应信息，但是拿不到响应方法的信息
 * 拦截器：可以获得Http原始的请求和响应信息，也可以得到响应方法的信息，但不能拿到方法参数
 * 切面Aspect: 可以拿得到方法响应中参数的值，但是拿不到原始的Http请求和相对应响应的方法
 */
@Slf4j
