...
public class RoleChangeListener {
  ...
  @KafkaListener(topics = {"KC_REALM_ROLE_MAPPING_CREATE",
      "KC_REALM_ROLE_MAPPING_DELETE"}, groupId = "${spring.application.name}", containerFactory = "manulKafkaListenerContainerFactory")
