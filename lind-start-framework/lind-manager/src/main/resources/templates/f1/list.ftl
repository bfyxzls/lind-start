...
<@layout.registrationLayout bodyClass="<span style='color:red'>修改模板里的变量</span>";section>
    ...
    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="/free/add" enctype="application/x-www-form-urlencoded" method="post">
        ...
        <div id="kc-form-buttons" class="form-group">
            ...
            <input tabindex="4" class="btn btn-primary btn-block btn-lg" name="login" id="kc-login" type="submit" value="登录">
        </div>
    </form>
