...
import com.lind.hbase.assertion.Assert;
import com.lind.hbase.constant.ExceptionMessage;
import com.lind.hbase.operations.HBaseOperations;
...
public class HBaseTemplate implements HBaseOperations {
    ...
    public void delete(String tableName, String rowName, String familyName, String qualifier) {
        ...
        try {
            table = connection.getTable(TableName.valueOf(tableName));
            Delete delete = new Delete(rowName.getBytes("UTF-8"));
            if (qualifier != null) {
                delete.addColumn(familyName.getBytes(CHARSET_NAME), qualifier.getBytes(CHARSET_NAME));
            }
            table.delete(delete);
        } catch (IOException e) {
