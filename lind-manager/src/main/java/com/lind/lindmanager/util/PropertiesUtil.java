...
public class PropertiesUtil {
	...
	/**
	 * <p>
	 * Detect file encoding from the first line of the property file. If the first line in
	 * the file doesn't contain the comment with the encoding, it uses ISO-8859-1 as
	 * default encoding for backwards compatibility.
	 * </p>
	 * <p>
