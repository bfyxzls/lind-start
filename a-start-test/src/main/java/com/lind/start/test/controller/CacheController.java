...
/**
 * redis cache default data 默认是二进制，如果希望JSON格式，需要添加自定义序列化bean,RedisCacheConfiguration [
 * "com.lind.start.test.dto.Info", { "title": "zzl", "msg": "lind", "createDate": [
 * "java.util.Date", "2022-02-17T07:03:38.926+00:00" ] } ]
 */
...
public class CacheController {
	...
	/**
	 * 带参数的，支持实体类型 redis key list::name,instance of list::zhansan
	 * @param name
	 * @return
	 */
	@GetMapping("detail")
