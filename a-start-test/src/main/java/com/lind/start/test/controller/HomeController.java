...
public class HomeController {
	...
	public ResponseEntity noTest() {
		return ResponseEntity.ok(new Info("hello", "hello world", new Date()));
	}

	@GetMapping("/shop")
	public ResponseEntity shop() {
		return ResponseEntity.ok(new Shop("苹果", "hello world", new Date(), null, 0));
	}

	@GetMapping("/product")
	public ResponseEntity product() {
		return ResponseEntity.ok(new Product("苹果", "hello world"));
	}
	...
	public Object test1(HttpServletRequest request, @RequestParam String sourceId, @RequestParam String userId)
