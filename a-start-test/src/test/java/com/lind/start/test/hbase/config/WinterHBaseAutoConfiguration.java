...
import com.lind.start.test.hbase.api.HBaseOperations;
import com.lind.start.test.hbase.service.HBaseService;
import com.lind.start.test.hbase.service.HBaseServiceImpl;
...
@EnableConfigurationProperties({WinterHBaseProperties.class})
@ConditionalOnProperty(value = "winter.hbase.enable", havingValue = "true", matchIfMissing = true)
public class WinterHBaseAutoConfiguration {


    private final WinterHBaseProperties properties;

    public WinterHBaseAutoConfiguration(WinterHBaseProperties properties) {
